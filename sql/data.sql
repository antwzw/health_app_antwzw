...
INSERT INTO following(username1,username2)
VALUES ('jag','michjc');
INSERT INTO comments(commentid,owner,postid,text, username)
VALUES ('1','awdeorio','3','#chickensofinstagram', 'jflinn');
INSERT INTO comments(commentid,owner,postid,text, username)
VALUES ('2','jflinn','3','I <3 chickens', 'awdeorio');
INSERT INTO comments(commentid,owner,postid,text, username)
VALUES ('3','michjc','3','Cute overload!', 'awdeorio');
INSERT INTO comments(commentid,owner,postid,text, username)
VALUES ('4','awdeorio','2','Sick #crossword', 'michjc');
INSERT INTO comments(commentid,owner,postid,text, username)
VALUES ('5','jflinn','1','Walking the plank #chickensofinstagram', 'michjc');
INSERT INTO comments(commentid,owner,postid,text, username)
VALUES ('6','awdeorio','1','This was after doing.', 'jag');
INSERT INTO comments(commentid,owner,postid,text, username)
VALUES ('7','jag','4','Saw this on the diag yesterday!', 'michjc');
